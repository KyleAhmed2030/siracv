const arTranslation = {
  ...
  "Modern": "عصري",
  "Executive": "تنفيذي",
  "Clean and professional design suitable for most industries.": "تصميم نظيف واحترافي مناسب لمعظم الصناعات.",
  "Modern and creative design for creative industries.": "تصميم عصري وإبداعي للصناعات الإبداعية.",
  "Simple and minimal design with clean typography.": "تصميم بسيط وأنيق مع طباعة نظيفة.",
  "Contemporary design with a touch of color.": "تصميم معاصر مع لمسة من اللون.",
  "Sophisticated design for senior positions.": "تصميم متطور لوظائف المستوى الأعلى.",
